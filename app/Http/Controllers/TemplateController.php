...
class TemplateController extends Controller
{
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function processArticle(Request $request)
    {   
        $this->validate($request, [
            ...
            'topic' => 'required',
            'main_focus' => 'required',
            'angle_approach' => 'required',
            'key_points' => 'required',
            'target_audience' => 'required',
            'brand_voice' => 'required',
            'additional_notes' => 'required',
            'primary_keyword' => 'required',
            'secondary_keywords' => 'required',
            'keyword_usage_guidelines' => 'required',
            'article_title' => 'required',
            'seo_title' => 'required',
            'meta_description' => 'required',
            'reference_content_1' => 'required|array',
            'paste_content' => 'required',
            'reference_content_2' => 'required|array',
            'paste_content2' => 'required'
        ]);        

        $request['objective'] = implode(',', $request->objective);
        $request['reference_content_1'] = implode(',', $request->reference_content_1);
        $request['reference_content_2'] = implode(',', $request->reference_content_2);
        ...
        $promptData = [
            'target_language' => mb_strtolower( $request->input('target_language') ),
            'content_type' => $request->input('content_type'),
            'country_language' => $request->input('country_language'),
            'objective' => $request->input('objective'),
            'topic' => $request->input('topic'),
            'main_focus' => $request->input('main_focus'),
            'angle_approach' => $request->input('angle_approach'),
            ...
            'keyword_usage_guidelines' => $request->input('keyword_usage_guidelines'),
            'article_title' => $request->input('article_title'),
            'seo_title' => $request->input('seo_title'),
            'meta_description' => $request->input('meta_description'),
            'reference_content_1' => $request->input('reference_content_1'),
            'paste_content' => $request->input('paste_content'),
            'reference_content_2' => $request->input('reference_content_2'),
            'paste_content2' => $request->input('paste_content2'),
        ];

        try {
            $documents = $this->documentsStore($request, __($template->prompt, $promptData));
