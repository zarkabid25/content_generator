...
use App\Mail\SendEmailVerficationURL;
    ...
    */
    ...
    public function redirectTo()
    {
        if(auth()->user()){
           ...
           // Session::put('email_message', 'Your request has been sent for registration. We will get back to you soon.');
    ...
    protected function create(array $data)
    {
        ...
        if (config('settings.registration')) {
            ...
            if($emailDomain[1] == 'argosmultilingual.com') 
            {
