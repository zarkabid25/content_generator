...
Route::get('/email_verify/{isverified}/{email}', 'HomeController@emailVerification')->name('email.verify');
Route::get('/verification_pending', function(){
    return view('registration-pending.pending-register-message');
